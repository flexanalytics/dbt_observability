{#
    Since folks commonly install dbt_observability alongside a myriad of other packages,
...
{%- macro surrogate_key(field_list) -%}
    ...
    {{ return(adapter.dispatch('surrogate_key', 'dbt_observability')(field_list, *varargs)) }}
{% endmacro %}
