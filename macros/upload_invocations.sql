{% macro upload_invocations() -%}
    {{ return(adapter.dispatch('get_invocations_dml_sql', 'dbt_observability')()) }}
{%- endmacro %}
...
{% macro default__get_invocations_dml_sql() -%}
    ...
    select
        ...
        nullif({{ adapter.dispatch('column_identifier', 'dbt_observability')(12) }}, ''),
        nullif({{ adapter.dispatch('column_identifier', 'dbt_observability')(13) }}, ''),
        nullif({{ adapter.dispatch('column_identifier', 'dbt_observability')(14) }}, ''),
        nullif({{ adapter.dispatch('column_identifier', 'dbt_observability')(15) }}, ''),
        nullif({{ adapter.dispatch('column_identifier', 'dbt_observability')(16) }}, ''),
        {{ adapter.dispatch('parse_json', 'dbt_observability')(adapter.dispatch('column_identifier', 'dbt_observability')(17)) }},
        {{ adapter.dispatch('parse_json', 'dbt_observability')(adapter.dispatch('column_identifier', 'dbt_observability')(18)) }}
    from values
