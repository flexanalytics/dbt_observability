{% macro insert_into_metadata_table(database_name, schema_name, table_name, content) -%}
    {% if content != "" %}
        {{ return(adapter.dispatch('insert_into_metadata_table', 'dbt_observability')(database_name, schema_name, table_name, content)) }}
    {% endif %}
{%- endmacro %}
...
{% macro redshift__insert_into_metadata_table(database_name, schema_name, table_name, content) -%}
